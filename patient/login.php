 ...
 * ==========================================
 * 
 * This file handles patient authentication and login functionality.
 * It validates user credentials against the database and creates
 * a session for authenticated patients.
 * 
 * Features:
 * - Email and password validation
 * - Secure password verification using password_verify()
 * - Session management for logged-in patients
